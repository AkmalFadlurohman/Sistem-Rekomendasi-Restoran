...
(deffacts restaurants-data
    (restaurant-data (name "Restaurant A") (smoke yes) (min-budget 1000) (max-budget 2000) (dresscode casual) (wifi no) (latitude -6.8922186) (longitude 107.5886173))
    ...
    (restaurant-data (name "Restaurant L") (smoke no) (min-budget 1400) (max-budget 3000) (dresscode casual) (wifi no) (latitude -6.1881082) (longitude 106.7844410))
...
(defrule dresscode-casual-reposition
	...
	(test (eq ?score1 ?score2))
	(test (eq ?d1 ?d2))
	(test (and (not (member casual ?dress1)) (member casual ?dress2)));
	(test (> ?rank2 ?rank1))
=>
	(retract ?f1)
	(retract ?f2)
...
(defrule dresscode-informal-reposition
	...
	(test (eq ?score1 ?score2))
	(test (eq ?d1 ?d2))
	(test (and (not (member casual ?dress1)) (not (member casual ?dress2))));
	(test (and (not (member informal ?dress1)) (member informal ?dress2)));
	(test (> ?rank2 ?rank1))
=>
	(retract ?f1)
	(retract ?f2)
